...
return [
    ...
    'templates' => [
        ...
        'duplicate_success' => 'Копия была создана.',
        'reset_success' => 'Запись была восстановлена из файла представления.',
        ...
        'reset_view_only' => 'Сбросить можно только запись, созданную из файла представления.',
    ],
    'template' => [
        'menu_label' => 'Шаблон',
    ...
    'demo' => [
        'enabled' => 'Демонстрационные шаблоны были включены.',
        'disabled' => 'Демонстрационные шаблоны были отключены.',
    ],
];
